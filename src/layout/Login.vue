    ...
    <div class="user_options-container">
      <div class="user_options-text">
        <div class="user_options-unregistered">
          ...
          <p class="user_unregistered-text">
            Não se preocupe, crie uma e aproveite dessa aplicação para
        ...
        <div class="user_options-registered">
          ...
          <p class="user_registered-text">
            Pode começar a ver quais são suas notificações ou enviar
            notificações para quem precisa!
          </p>
          <button
      ...
      <div class="user_options-forms" id="user_options-forms">
        ...
        <div class="user_forms-signup">
          <h2 class="forms_title">Criação de Conta</h2>
          <p class="text-muted" style="font-size: 12px">
            <small
              >Lembre-se de pedir para o administrador da sua congregação para
              te incluir no grupo.</small
            >
          </p>
          <form class="forms_form">
            <fieldset class="forms_fieldset">
...
export default {
  ...
  methods: {
    fSignupButton() {
      ...
      this.userForm.classList.remove("bounceRight");
      this.userForm.classList.add("bounceLeft");
    },
    fLoginButton() {
      this.userForm = document.getElementById("user_options-forms");
